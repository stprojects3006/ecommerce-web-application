...
function Login() {
    ...
    return (
        <>
            <main className='auth-container gold-theme'>
                <div className='auth-wrapper gold-card'>
                    <Link to="/" style={{alignSelf: 'flex-start', marginBottom: '10px', color: '#bfa14a', fontWeight: 600, textDecoration: 'none'}}>Home</Link>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Logo />
                        <h2 style={{color: '#bfa14a'}}>Login to continue...</h2>
                        {
                            error && <p>{error}</p>
                        }
